...
**Научный календарь** — это Telegram-бот для популяризации истории науки и техники. Он ежедневно присылает пользователям информацию о значимых научных открытиях и днях рождения учёных, произошедших в эту дату. Бот поддерживает интерактивные викторины, формирует рейтинг пользователей и позволяет получить случайный научный факт по запросу.
